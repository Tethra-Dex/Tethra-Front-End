    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="w-full justify-between bg-trading-surface border-border-default hover:bg-trading-elevated text-text-primary"
        >
          {value ? (
            <div className="flex items-center gap-2">
              ...
              />
              <span>{formatMarketPair(value.symbol)}</span>
            </div>
          ) : (
            'Select market...'
          )}
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <Image
                        ...
                        className="rounded-full"
                      />
                      <span>{formatMarketPair(market.symbol)}</span>
                    </div>
                    <button
