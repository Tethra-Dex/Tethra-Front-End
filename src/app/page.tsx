  ...
  return (
    <div className="w-full bg-black text-white overflow-hidden">
      ...
      <section ref={chainsRef} id="supported-chains" className="relative py-32 px-4 bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden">
        ...
        <div
          className="absolute left-0 top-1/2 -translate-y-1/2 pointer-events-none z-10 transition-all duration-700 ease-out"
          style={{
            left: '-250px',
        ...
        >
          <div className="relative w-[500px] h-[500px]">
            ...
            <div className="absolute inset-0 rounded-full border-4 border-emerald-500/30" style={{ clipPath: 'polygon(50% 0, 100% 0, 100% 100%, 50% 100%)' }}></div>

            {/* Tethra Logo - Right half visible */}
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden" style={{ clipPath: 'polygon(50% 0, 100% 0, 100% 100%, 50% 100%)' }}>
            ...
            <div className="absolute left-1/2 top-[10%] translate-x-[20%] pointer-events-auto">
              <div className="flex flex-col items-center gap-2">
                <div className="w-16 h-16 rounded-full bg-gray-900/90 backdrop-blur-sm flex items-center justify-center border-2 border-emerald-500/40 hover:border-emerald-500 hover:scale-110 transition-all cursor-pointer">
                  <Image
                ...
                <span className="text-xs font-semibold text-emerald-400 whitespace-nowrap">Next.js</span>
              </div>
            </div>
            ...
            <div className="absolute right-[15%] top-1/2 -translate-y-1/2 pointer-events-auto">
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-xs font-semibold text-emerald-400 whitespace-nowrap">React</span>
              </div>
            </div>
            ...
            <div className="absolute left-1/2 bottom-[10%] translate-x-[20%] pointer-events-auto">
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-xs font-semibold text-emerald-400 whitespace-nowrap">Tailwind</span>
              </div>
            </div>
        ...
        <div
          className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none z-10 transition-all duration-700 ease-out"
          style={{
            right: '-250px',
            opacity: isChainsVisible ? 1 : 0,
            transform: `translateY(-50%) translateX(${isChainsVisible ? '0' : '100px'})`
        ...
        >
          <div className="relative w-[500px] h-[500px]">
            ...
            <div className="absolute inset-0 rounded-full border-4 border-cyan-500/30" style={{ clipPath: 'polygon(0 0, 50% 0, 50% 100%, 0 100%)' }}></div>

            {/* Tethra Logo - Left half visible */}
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden" style={{ clipPath: 'polygon(0 0, 50% 0, 50% 100%, 0 100%)' }}>
            ...
            <div className="absolute left-1/2 top-[10%] -translate-x-[120%] pointer-events-auto">
              <div className="flex flex-col items-center gap-2">
                <div className="w-16 h-16 rounded-full bg-gray-900/90 backdrop-blur-sm flex items-center justify-center border-2 border-cyan-500/40 hover:border-cyan-500 hover:scale-110 transition-all cursor-pointer">
                  <svg viewBox="0 0 111 111" className="w-10 h-10" fill="none">
                    <circle cx="55.5" cy="55.5" r="55.5" fill="#0052FF"/>
                    <path d="M54.9219 85.8281C71.9719 85.8281 85.8438 71.9563 85.8438 54.9063C85.8438 37.8563 71.9719 23.9844 54.9219 23.9844C39.0469 23.9844 25.9844 35.8688 24.2344 51.3688H65.1594V58.4438H24.2344C25.9844 73.9438 39.0469 85.8281 54.9219 85.8281Z" fill="white"/>
                  </svg>
                </div>
            ...
            <div className="absolute left-[15%] top-[25%] pointer-events-auto">
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-xs font-semibold text-cyan-400 whitespace-nowrap">Foundry</span>
              </div>
            </div>
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="w-16 h-16 rounded-full bg-gray-900/90 backdrop-blur-sm flex items-center justify-center border-2 border-cyan-500/40 hover:border-cyan-500 hover:scale-110 transition-all cursor-pointer">
                  <svg viewBox="0 0 293 163" className="w-10 h-10" fill="none">
                    ...
                    <path d="M146.5 163L73 103L146.5 81.5L220 103L146.5 163Z" fill="#627EEA" opacity="0.6"/>
                  </svg>
                </div>
                <span className="text-xs font-semibold text-cyan-400 whitespace-nowrap">ethers.js</span>
              </div>
            </div>
      ...
      <section id="smart-contracts" className="relative py-20 px-4 bg-black overflow-hidden">
        <div className="container mx-auto max-w-7xl">
...
23
24    function `}<span className="text-cyan-400">placeBet</span>{`(
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3 group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Minimal transaction costs for maximum efficiency</p>
                  </div>
                </div>
