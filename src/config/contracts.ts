...
// Token Contracts
export const USDC_ADDRESS = (process.env.NEXT_PUBLIC_USDC_TOKEN_ADDRESS || '0x97e79F7189144F2A67d56ef9164B8230784014cD') as `0x${string}`;
export const TETHRA_TOKEN_ADDRESS = (process.env.NEXT_PUBLIC_TETHRA_TOKEN_ADDRESS || '0xe5A50E831695f4e438fFe877F4970f14778DeB28') as `0x${string}`;

// Core Trading Contracts
export const MARKET_EXECUTOR_ADDRESS = (process.env.NEXT_PUBLIC_MARKET_EXECUTOR_ADDRESS || '0x169BD27456DEF7AF81Cee3F188e4C316aF7c3fE5') as `0x${string}`;
export const LIMIT_EXECUTOR_ADDRESS = (process.env.NEXT_PUBLIC_LIMIT_EXECUTOR_ADDRESS || '0x7690eBE5D0AF8eeBFdF7F18d0De2d4f568a1bf47') as `0x${string}`;
export const TAP_TO_TRADE_EXECUTOR_ADDRESS = (process.env.NEXT_PUBLIC_TAP_TO_TRADE_EXECUTOR_ADDRESS || '0xb7983AF018547Ef34Af65869cdB2E47264630532') as `0x${string}`;
export const POSITION_MANAGER_ADDRESS = (process.env.NEXT_PUBLIC_POSITION_MANAGER_ADDRESS || '0x45e985eE1d038d942536270c8662eb5cBFeCa6ef') as `0x${string}`;
export const RISK_MANAGER_ADDRESS = (process.env.NEXT_PUBLIC_RISK_MANAGER_ADDRESS || '0xB07eFBDd2c31cD97583C91679c9b7B244Db22F0D') as `0x${string}`;

// Treasury Stack
export const VAULT_POOL_ADDRESS = (process.env.NEXT_PUBLIC_VAULT_POOL_ADDRESS || '0xA880d810Ab6fAc4c60A2b4B8D829fC37f41e2aF9') as `0x${string}`;
export const STABILITY_FUND_ADDRESS = (process.env.NEXT_PUBLIC_STABILITY_FUND_ADDRESS || '0x1A7763D20C262Faa477C376BFBfE1B712b51D5C8') as `0x${string}`;

// Economic Contracts
export const TETHRA_STAKING_ADDRESS = (process.env.NEXT_PUBLIC_TETHRA_STAKING_ADDRESS || '0x583578f24DCC3f43eefa91bE1a530CBB06faf189') as `0x${string}`;

// Utility Contracts
export const USDC_PAYMASTER_ADDRESS = (process.env.NEXT_PUBLIC_USDC_PAYMASTER_ADDRESS || '0x8b4AC6b2Dbb9fC97c62C0c086f2932c143DCCc91') as `0x${string}`;
